...
import org.utm.gct.GradleCacheTool;

import java.io.*;
import java.math.BigInteger;
import java.util.ArrayList;

public class GCTImpl extends GradleCacheTool {

    public GCTImpl(String filename) {
        this.keySerializer = SerializerFactoryImpl.instance.getKeySerializer(filename);
        this.valueSerializer = SerializerFactoryImpl.instance.getValueSerializer(filename);
    }
